...
ExecutionStats* Solver::backTracking(Board* objective){
...
ExecutionStats* Solver::DFS(Board* objective, int limit){
...
ExecutionStats* Solver::BFS(Board* objective){
    clock_t begin_time = clock();
    Node* current = new Node(NULL, root->board, -1);
    Node* root_copy = current;
...
ExecutionStats* Solver::uniformCostSearch(Board* objective){
    ExecutionStats* stats = BFS(objective);
    stats->method = "uniform";
    return stats;
}

ExecutionStats* Solver::greedySearch(Board* objective){
    clock_t begin_time = clock();
    Node* current = new Node(NULL, root->board, -1);
    Node* root_copy = current;
...
ExecutionStats* Solver::aStar(Board* objective){
    clock_t begin_time = clock();
    Node* current = new Node(NULL, root->board, -1);
    Node* root_copy = current;
...
ExecutionStats* Solver::idaStar(Board* objective){
    clock_t begin_time = clock();
    Node* current = new Node(NULL, root->board, -1);
    Node* root_copy = current;
...
void Solver::printPath(Node* leaf){
